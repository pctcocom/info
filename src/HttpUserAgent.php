 ...
 * @name Browser
 * @describe 浏览器
 * @author https://github.com/cbschuld/Browser.php
 **/
class HttpUserAgent{
	private $_agent = '';
	...
	* @return bool 如果浏览器是指定的浏览器，则为True
	*/
	...
	*/
	...
	/**
	* 浏览器的版本。
	* @return string 浏览器的版本（仅包含字母数字字符和句点）
	*/
	...
	*/
	...
	/**
	* AOL的版本。
	* @return string AOL版本（仅包含字母数字字符和句点）
	*/
	...
	*/
	...
	/**
	* 浏览器是来自AOL吗？
	* @return boolean 如果浏览器来自AOL，则为true；否则为false
	*/
	...
	/**
	* 浏览器是否来自移动设备？
	* @return boolean 如果浏览器来自移动设备，则为true，否则为false
	*/
	...
	/**
	* 浏览器是否来自平板电脑设备？
	* @return boolean 如果浏览器来自平板设备，则为true，否则为false
	*/
	...
	/**
	* 浏览器是否来自机器人（例如Slurp，GoogleBot）？
	* @return boolean 如果浏览器来自机器人，则为true，否则为false
	*/
	...
	/**
	* 浏览器是来自facebook吗？
	* @return boolean 如果浏览器来自facebook，则为true，否则为false
	*/
	...
	*/
	...
	/**
	* 将浏览器设置为可移动
	* @param boolean $value 浏览器是否是移动浏览器
	*/
	...
	/**
	* 将浏览器设置为平板电脑
	* @param boolean $value 浏览器是否是平板电脑浏览器
	*/
	...
	*/
	...
	/**
	* 设置用户代理值（构造将使用HTTP标头值-这将覆盖它）
	* @param string $agent_string 用户代理的值
	*/
	...
	/**
	* 用于确定浏览器是否实际上是“ chromeframe”
	* @since 1.7
	* @return boolean 如果浏览器使用chromeframe，则为true
	*/
	...
	*/
	...
	/**
	* 受保护的例程，以确定浏览器类型
	* @return boolean 如果检测到浏览器，则为true，否则为false
	*/
	...
	/**
	* 确定用户是否正在使用BlackBerry（最新更新为1.7）
	* @return boolean 如果浏览器是BlackBerry浏览器，则为true，否则为false
	*/
