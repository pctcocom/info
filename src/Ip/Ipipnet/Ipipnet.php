<?php
namespace Pctco\Info\Ip\Ipipnet;
class Ipipnet{
   /**
   * ipip.net 本地数据库 local.datx
   * @author  https://www.ipip.net/product/client.html
   * @version 20180702
   **/
   ...
   private static function init(){
      if (self::$fp === NULL){
           ...
           self::$fp = fopen(__DIR__ . '/ipipnet.datx', 'rb');
           if (self::$fp === FALSE){
               throw new Exception('Invalid ipipnet.datx file!');
           }
